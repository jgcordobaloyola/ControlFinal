...
<html lang="es">
    ...
    <body class="text-dark"> 
        ...
        <div class="container">
            <img src="http://www.elhospital.com/documenta/imagenes/121080/agua-laboratorio.jpg" alt="imagenes de laboratorio" class="img-thumbnail">
            <!--<img src="https://i2-prod.manchestereveningnews.co.uk/incoming/article11701857.ece/ALTERNATES/s615/intertek3.jpg" alt="imagenes" class="img-thumbnail"> -->
        </div>
        ...
        <script type="text/javascript">
                $(document).ready(function () {
                    $("#signupbtn").click(function (event) {
                        ...
                        $.post("../../createUser", body, function (a, b, c) {
                            swal(
                                    'Excelente!',
                                    'Usuario Creado!',
                                    'success'
